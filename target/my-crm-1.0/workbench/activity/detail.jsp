                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data) {
                            ...
                            window.location.href = 'workbench/Activity/detail.do?id=' + ($("${a.id}").val())
                        } else {
                            alert('更新失败')
                        }
                    }
    ...
    <div class="modal-dialog" role="document" style="width: 85%;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="editModalLabel">修改市场活动</h4>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                <button type="button" class="btn btn-primary" id="editUpdate">更新</button>
            </div>
        </div>
    </div>
</div>
...
<div style="position: relative; left: 40px; top: -30px;">
    ...
    <div style="position: relative; height: 50px; width: 250px;  top: -72px; left: 700px;">
        <button type="button" class="btn btn-default" id="btnEdit"><span class="glyphicon glyphicon-edit"></span> 编辑
        </button>
