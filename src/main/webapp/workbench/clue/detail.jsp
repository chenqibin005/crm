	...
	$(function(){
		...
		$("#bundModal").keydown(function (event) {
				if (event.keyCode==13){
					...
					$.ajax({
						url:"workbench/Clue/getActivityListByAIdandNotByClueId.do",
						data:{
							"aname":$.trim($("#serach-activity").val()),
							"clueId":"${clue.id}"
						},
						type:"get",
						dataType:"json",
		...
		$.ajax({
			...
			success:function (data) {
				...
				$.each(data,function (i,n) {
					...
					html+='	<td>'+n.endDate+'</td>'
					html+='	<td>'+n.owner+'</td>'
					html+='	<td><a href="javascript:void(0);" onclick="reBund(\''+n.id+'\')"  style="text-decoration: none;"><span class="glyphicon glyphicon-remove"></span>解除关联</a></td>'
					html+='	</tr>'
				})
		...
		<div class="modal-dialog" role="document" style="width: 80%;">
			<div class="modal-content">
					...
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input type="text" id="serach-activity" class="form-control" style="width: 300px;" placeholder="请输入市场活动名称，支持模糊查询">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" id="activityRel">关联</button>
				</div>
			</div>
		</div>
	</div>
